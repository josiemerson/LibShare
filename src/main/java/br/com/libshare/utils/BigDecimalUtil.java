...
public class BigDecimalUtil {
	...
	public static BigDecimal buildFromDouble(double d) {
		...
		if (asInt != d) { // evita o zero à esquerda.
	...
	public static BigDecimal buildFromDouble(Number d) {
		...
		if (d != null) {
			...
			if (asInt != value) { // evita o zero à esquerda.
	...
	public static BigDecimal divide(BigDecimal dividend, BigDecimal divider, int precision) {
		if (dividend == null) {
			throw new IllegalStateException("O valor informado como dividendo não pode ser nulo.");
		}

		if (divider == null) {
			throw new IllegalStateException("O valor informado como divisor não pode ser nulo.");
		}
